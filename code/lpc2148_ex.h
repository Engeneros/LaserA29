...
/* Pin Connect Block */
const unsigned long PINSEL_BASE_ADDR = 0xE002C000; 
#define PINSEL0         (*((volatile unsigned long *) 0xE002C000))
#define PINSEL1         (*((volatile unsigned long *) 0xE002C004))
#define PINSEL2         (*((volatile unsigned long *) 0xE002C014))

/* General Purpose Input/Output (GPIO) */
const unsigned long GPIO_BASE_ADDR = 0xE0028000;
...
const unsigned long FIO_BASE_ADDR = 0x3FFFC000;
...
// const unsigned long SPI0_BASE_ADDR = 0xE0020000;
...
// const unsigned long SSP1_BASE_ADDR = 0xE0068000;
...
// struct RegsSPI
// {
// 	volatile unsigned short spcr;//0
// 		volatile unsigned short hole0;//2
// 	volatile unsigned char  spsr;//	4
// 		volatile unsigned char  hole1;//5
// 		volatile unsigned short hole2;//6
// 	volatile unsigned short spdr;//	8
// 		volatile unsigned short  hole3;//a
// 	volatile unsigned char  spccr;//     c
// 		volatile unsigned char  hole4;//d
// 		volatile unsigned short hole5;//e
// 		volatile unsigned long  hole6;//10
// 		volatile unsigned long  hole7;//14
// 		volatile unsigned long  hole8;//18
// 	volatile unsigned char  spint;//1c
// };

// struct RegsSSP
// {
// 	volatile unsigned short cr0;//0
// 		volatile unsigned short hole0;//2
// 	volatile unsigned char  cr1;//	4
// 		volatile unsigned char  hole1;//5
// 		volatile unsigned short hole2;//6
// 	volatile unsigned short dr;//	8
// 		volatile unsigned short  hole3;//a
// 	volatile unsigned char  sr;//     c
// 		volatile unsigned char  hole4;//d
// 		volatile unsigned short hole5;//e
// 	volatile unsigned char  cpsr;//10
// 		volatile unsigned char hole6;//11
// 		volatile unsigned short hole7;//12
// 	volatile unsigned char imsc;//	14
// 		volatile unsigned char hole8;//15
// 		volatile unsigned short hole9;//16
// 	volatile unsigned char ris;//	18
// 		volatile unsigned char hole10;//19
// 		volatile unsigned short hole11;//1a
// 	volatile unsigned char mis;//1c
// 		volatile unsigned char hole12;//1d
// 		volatile unsigned short hole13;//1e
// 	volatile unsigned char icr;//20	
// 		volatile unsigned char hole14;//21
// 		volatile unsigned short hole15;//22
// //	volatile unsigned char dmacr;//24	
// };



/* SPI0 (Serial Peripheral Interface 0) */
const unsigned long SSP0_BASE_ADDR  = 0xE0020000; ///SPI0_BASE_ADDR = 0xE0020000;
...
/* A/D Converter 0 (AD0) */
const unsigned long AD0_BASE_ADDR = 0xE0034000;
...
/* A/D Converter 1 (AD1) */
const unsigned long AD1_BASE_ADDR = 0xE0060000;
